...
const PoliticaCookies = () => {
  ...
  return (
    <div className="container2">
      ...
      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Principal_Titulo" })}</h3>
      <p className="ti-20p">{intl.formatMessage({ id: "politicaCookies_Principal_Texto" })}</p>

      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Informacion_Titulo" })}</h3>
      <p className="ti-20p">{intl.formatMessage({ id: "politicaCookies_Informacion_Texto" })}</p>

      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Clasificacion_Titulo" })}</h3>
      ...
      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Utilizadas_Titulo" })}</h3>
      ...
      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Aceptacion_Titulo" })}</h3>
      ...
      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Denegacion_Titulo" })}</h3>
      <p className="ti-20p">{intl.formatMessage({ id: "politicaCookies_Denegacion_Texto" })}</p>

      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Desactivacion_Titulo" })}</h3>
      ...
      <h3 className="mt-25p mb-10p">{intl.formatMessage({ id: "politicaCookies_Actualizacion_Titulo" })}</h3>
