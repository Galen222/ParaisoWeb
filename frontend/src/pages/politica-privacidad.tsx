...
const PoliticaPrivacidadPage: NextPage & { pageTitleText?: string } = (): React.JSX.Element => {
  ...
  return (
    <div className="pageContainer">
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_DatosIdentificativos_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Principios_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Datos_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Derechos_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Finalidad_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Seguridad_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Contenido_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_PoliticaCookies_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Legitimacion_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Categorias_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Conservacion_Titulo" })}</h3>
        <p className="ti-20p">{intl.formatMessage({ id: "politicaPrivacidad_Conservacion_Texto" })}</p>
      </div>
      {/* Sección de destinatarios de los datos */}
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Destinatarios_Titulo" })}</h3>
        <ul className={styles.listas}>
          <li>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Navegacion_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Veracidad_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Aceptacion_Titulo" })}</h3>
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Revocabilidad_Titulo" })}</h3>
        <p className="ti-20p">
      ...
      <div className="mt-25p">
        <h3 aria-level={2} className="mb-10p">{intl.formatMessage({ id: "politicaPrivacidad_Actualizacion_Titulo" })}</h3>
