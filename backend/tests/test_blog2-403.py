...
Script para probar el endpoint de detalle de blog por slug con un token inválido.
...
def test_blog_detail_token_invalido():
    """
    Realiza una petición GET al endpoint de detalle de blog con un token inválido.
...
if __name__ == "__main__":
    test_blog_detail_token_invalido()