"""
test_charcuteria-403.py

Script para probar el endpoint de charcutería con un token inválido.
...
def test_charcuteria_token_invalido():
    """
    Realiza una petición GET al endpoint de charcutería con un token inválido.
...
if __name__ == "__main__":
    test_charcuteria_token_invalido()